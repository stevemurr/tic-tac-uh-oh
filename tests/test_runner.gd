...
func _collect_tests(s) -> Array[Dictionary]:
	...
	tests.append({"name": "comp/crossfire_3x3", "callable": s.test_comp_crossfire_3x3})
	tests.append({"name": "comp/crossfire_blocked_stops_ray", "callable": s.test_comp_crossfire_blocked_stops_ray})
	tests.append({"name": "comp/stack_crossfire_gravity", "callable": s.test_comp_stack_crossfire_gravity})
	...
	tests.append({"name": "edge/all_complications_used_tracks_registry", "callable": s.test_edge_all_complications_used_tracks_registry})
